...
import { ShieldCheck, ChevronDown, LayoutDashboard, Users, Layers, User, Building2, ClipboardCheck, UserCog, Coins } from "lucide-react";
...
const menu: Root[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        to: "/auth/user",
        children: [
          { label: "个人实名认证", to: "/auth/user/personal", icon: User },
