      ...
      <Card className="p-5 space-y-4">
        <div className="flex items-stretch gap-2 rounded-2xl bg-white pl-2 py-2 overflow-hidden ring-1 ring-slate-200 focus-within:ring-primary/60 transition-all">
          <Select value={scope} onValueChange={(v) => setScope(v as "product" | "hs")}>
            <SelectTrigger className="h-11 w-[180px] min-w-[180px] border-0 bg-transparent hover:bg-transparent focus:ring-0 focus:ring-offset-0 rounded-none text-sm font-medium text-slate-700 shrink-0 whitespace-nowrap self-start px-3">
              <SelectValue />
            </SelectTrigger>
